...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container">
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          <li class="active"><a href="validasipembayaran.php">Validasi Transaksi</a></li>
  ...
  <main id="main">
    ...
    <?php
        $koneksi = new mysqli("localhost", "root", "", "onpay");
        if($koneksi == false){
        die("ERROR : TIDAK BISA TERHUBUNG.".mysqli_connect_error);
        }else{
            /*echo "Koneksi Berhasil <br/>";*/
        }
        $query = "select * from pembayaran where status=0";
    ...
    ?>
                  <tr>
                    ...
                    <td><a href="validasi_exe.php?konper=<?php echo $baris[1] ?>"><center>[✔]</center></a>
                    </td>
                    <td><a href="validasitolak_exe.php?konper=<?php echo $baris[1]?>"><center>[❌]</center></a>
                    </td>
                  </tr>
      <?php
                }
