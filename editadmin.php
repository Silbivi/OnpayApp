...
<body>
  ...
  <main id="main">
    ...
    <!-- ======= Keranjang Section ======= -->    
            ...
            <form action="editadmin_exe.php" method="post" enctype="multipart/form-data">
    ...
    ?>
            ...
            <table style="border-style:solid; border-color:#f2f2f2; padding-left:50vh;">
                ...
                <tr>
                    ...
                    <input type="text" class="form-control" name="bagian" id="bagian" value="Admin" style="display:none;" placeholder="Bagian" /></td>
                <tr>
