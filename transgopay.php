...
<?php
    ...
    ?>
          <div class="col-lg-6">
            <form action="gopay_exe.php" method="post" class="form-transaksi">
              <div class="form-group">
                <input type="text" class="form-control" name="kodegopay" id="kodegopay" placeholder="Kode Transaksi" value="<?= $idnya;?>" readonly/>
              </div>
            <div class="form-group">
                <input type="text" class="form-control" name="transgopay" id="transgopay" placeholder="Jenis Transaksi" value="GoPay" readonly/>
              </div>

              <div class="form-group">
                <input type="text" class="form-control" name="nominalgopay" id="nominalgopay" placeholder="Nominal Transaksi" />
              </div>
