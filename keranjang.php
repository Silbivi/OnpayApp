...
<body>
  ...
  <main id="main">
    ...
    <?php
        ...
        $query = "select * from transaksi where statuss!=1";
    ...
    ?>
                  <tr>
                    ...
                    <td><a href="pembayaran.php?kodet=<?php echo $baris[0]?>&nomin=<?php echo $baris[2]?>">[Bayar]</a>
                    </td>
                    <td><a href="delete.php?kodet=<?php echo $baris[0]?>"><center><b>⌫</b></center></a>
                    </td>
                  </tr>
      <?php
                }
