...
<?php
    ...
    ?>
          ...
          <div class="col-lg-6">
            <form action="ovo_exe.php" method="post" class="form-transaksi">
              <div class="form-group">
                <input type="text" class="form-control" name="kodeovo" id="kodeovo" placeholder="Kode Transaksi" value="<?= $idnya;?>" readonly/>
              </div>
            <div class="form-group">
                <input type="text" class="form-control" name="transovo" id="transovo" placeholder="Jenis Transaksi" value="OVO" readonly/>
              </div>

              <div class="form-group">
                <input type="text" class="form-control" name="nominalovo" id="nominalovo" placeholder="Nominal Transaksi" />
              </div>
